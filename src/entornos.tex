...
\begin{figure}[!t]
    \vspace{-15mm} 
    \includegraphics[width=\textwidth]{Chapters/entornos/imgs/carat_entornos.jpeg}
\end{figure}
...
\pyfile[lastline=16]{Chapters/entornos/code/oscilador_con_pep723.py}
...
\begin{shell}
    ...
    ‎  $ pipenv shell
\end{shell}
% la última línea arriba tiene un caracter "blanco no espacio" al principio, para que no sea coloreada como "prompt"
